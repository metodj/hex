...
public class GlavnoOkno extends JFrame implements ActionListener{
	...
	public GlavnoOkno() {
		...
		velikostMenu = new JMenuItem("Velikost plošče");
	...
	private void osveziGUI() {
		if (igra == null) {
			...
			case POTEZA_RDECI: status.setText("Na potezi je rdeči."); break;
			case ZMAGA_MODRI: status.setText("Zmagal je modri!"); break;
			case ZMAGA_RDECI: status.setText("Zmagal je rdeči!"); break;
			}
		}
		polje.repaint();
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == igraClovekRacunalnik) {
			...
			String n = JOptionPane.showInputDialog("Vnesi velikost plošče (igra računalnika bo onemogočena za velikosti večje od 11):");
